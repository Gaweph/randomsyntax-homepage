<script>
  ...
  const photos_cube = [
    "/content/blog/images/3d-printing/cube_a.jpg",
    "/content/blog/images/3d-printing/cube_b.jpg",
    "/content/blog/images/3d-printing/cube_c.jpg"
  ];
  const photos_elephant = [
    "/content/blog/images/3d-printing/elephant_a.jpg",
    "/content/blog/images/3d-printing/elephant_b.jpg"
  ];
  const photos_octopus = [
    "/content/blog/images/3d-printing/octopus_a.jpg",
    "/content/blog/images/3d-printing/octopus_b.jpg",
    "/content/blog/images/3d-printing/octopus_c.jpg"
  ];
</script>
